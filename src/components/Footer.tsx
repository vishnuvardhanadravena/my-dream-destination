      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-zinc-500 dark:text-zinc-400 max-w-sm leading-relaxed">
              Your ultimate companion for exploring the vibrant landscapes,
              rich history, and diverse cultures of India. We bring you the best
              of every city, from monuments to street food.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-6">
              <a
                ...
                className="w-10 h-10 bg-zinc-100 dark:bg-zinc-800 rounded-full flex items-center justify-center text-zinc-600 dark:text-zinc-400 hover:bg-emerald-600 hover:text-white transition-all"
              >
        ...
        <div className="pt-8 border-t border-black/5 dark:border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-zinc-400 dark:text-zinc-500 text-sm">
            © 2026 My Dream Destination. All rights reserved.
          </p>
